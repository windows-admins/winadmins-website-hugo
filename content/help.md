...
Microsoft MVP|Granted to active Microsoft MVPs|Reach out to a server admin for assistance with adding this role
Microsoft Partner|Granted to active Microsoft Partners|Reach out to a server admin for assistance with adding this role
Trusted Vendor|Granted to users that are representing a vendor in an official capicity. This role also has a number of subroles for specific vendors that have multiple representatives|Reach out to a server admin for assistance with adding this role
SysManSquad Staff|Granted to members of the Systems Management Squad (https://sysmansquad.com/)|Reach out to a server admin for assistance with adding this role
...
catfact|Responds with a random cat fact (only works in #pets)|`-catfact`
delreminder|Deletes a reminder|`-delreminder <ID>`
dogfact|Responds with a random dog fact (only works in #pets)|`-dogfact`
...
stuck|Help someone that appears to be stuck in a voice channel (only works in #voice-along)|`-stuck @username`
