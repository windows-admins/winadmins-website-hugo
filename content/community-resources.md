...
*   [Client Health – ConfigMgr Client Health (Anders Rodland)](https://www.andersrodland.com/configmgr-client-health/)
...
*   [Client Health Startup Script – ConfigMgrFTW](https://home.configmgrftw.com/configmgr-client-startup-script/)
...
*   [Community Tools List (MISCUG – 2019)](https://github.com/chrisATautomatemystuff/Presentations/blob/master/MISCUG%20-%20November%202019%20-%20Community%20Tools.pdf)
*   [ConfigMgr OSD FrontEnd (Nickolaj Andersen)](https://gallery.technet.microsoft.com/ConfigMgr-OSD-FrontEnd-100-55209031)
*   [ConfigMgr Remote Compliance (Trevor Jones)](https://gallery.technet.microsoft.com/ConfigMgr-Remote-Compliance-2a9e55f3)
*   [ConfigMgr Task Sequence Monitor (Trevor Jones)](https://gallery.technet.microsoft.com/ConfigMgr-Task-Sequence-fefdc532)
*   [ConfigMgr WebService (SCConfigMgr)](https://www.scconfigmgr.com/configmgr-webservice/#)
*   [Configuration Manager Lab in Azure (MSDocs)](https://docs.microsoft.com/en-us/configmgr/core/get-started/azure-template)
*   [Create Software Update Group Tool](https://gallery.technet.microsoft.com/Create-Software-Update-bb775cd4)
*   [Did You Check The Logs?](https://www.dyctl.com/)
*   [Driver Automation Tool (Maurice Daly)](https://gallery.technet.microsoft.com/scriptcenter/Driver-Tool-Automate-9ddcc010)
*   [Enhansoft SCCM Free Reporting Giveaway](http://giveaway.enhansoft.com/)
*   [EveryCloud IT Pro Tuesdays](https://www.everycloud.com/it-pro-tuesday-full-list)
...
*   [Microsoft Premier Field Engineering](https://techcommunity.microsoft.com/t5/premier-field-engineering/bg-p/premierfieldengineeringblog)
*   [Modern BIOS Management (SCConfigMgr)](https://www.scconfigmgr.com/modern-bios-management/)
*   [Modern Drive Management (SCConfigMgr)](https://www.scconfigmgr.com/modern-driver-management/)
*   [Must Have Tools – 2018 (SystemCenterDudes)](https://www.systemcenterdudes.com/list-of-sccm-must-have-tools-2018-edition/)
*   [Onevinn Web Services for OSD (Johan Schrewelius)](https://gallery.technet.microsoft.com/Web-Service-for-OS-93b6ecb8)
*   [Operational SCCM Collections Script (Benoit Lecours)](https://gallery.technet.microsoft.com/Set-of-Operational-SCCM-19fa8178)
*   [OSDBuilder](https://osdbuilder.osdeploy.com/)
*   [PatchMaster Script (Robert Marshall)](https://gallery.technet.microsoft.com/PatchMaster-51716e13)
...
*   [Reg2CI](https://github.com/rzander/Reg2CI/releases)
*   [Right Click Tools (Recast)](https://www.recastsoftware.com/right-click-tools)
*   [RuckZuck Tools](https://ruckzuck.tools/)
*   [SCCM Application Packager (Andrew Jimenez)](https://github.com/asjimene/SCCM-Application-Packager)
*   [SCCM Extensions for Driver Management (Johan Schrewelius)](https://gallery.technet.microsoft.com/SCCM-Extensions-for-driver-be30b298)
*   [SCConfigMgr Prerequisite Tool (Donna Ryan)](http://www.thenotoriousdrr.com/index.php/2019/02/18/the-scconfigmgr-configmgr-prerequisite-tool/)
*   [SQL Server Maintenance Solution (Ola Hallegren)](https://ola.hallengren.com/downloads.html)
*   [SysManSquad](https://sysmansquad.com/)
*   [Test-CMApplication Script (Ryan Ephgrave)](https://gallery.technet.microsoft.com/Automatically-test-d96c8ec4)
*   [Top 10 Must-Have Tools for the ConfigMgr Admin (Adaptiva)](https://insights.adaptiva.com/2018/configmgr-admin-tools-top-10/)
*   [TSBackground Mark II (Johan Schrewelius)](https://gallery.technet.microsoft.com/Configuration-Manager-Task-6422b6f8)
*   [UI++](http://uiplusplus.configmgrftw.com/docs/intro/overview.html)
*   [USA – Colorado / Online – Modern Enterprise Management User Group (MEMUG)](https://memug.org/)
*   [WIM Witch – A GUI Driven Solution for Image Customization (Donna Ryan)](https://www.scconfigmgr.com/2019/10/04/wim-witch-a-gui-driven-solution-for-image-customization/)
...
*   [Hydration Kit For WinServer 2016 and ConfigMgr CB/TPB](https://deploymentresearch.com/hydration-kit-for-windows-server-2016-and-configmgr-current-technical-preview-branch/)
*   [Image Factory](https://deploymentbunny.com/2018/10/19/image-factory-4-0-is-available-for-download/)
*   [LUA Buglight](https://blogs.msdn.microsoft.com/aaron_margosis/2015/06/30/lua-buglight-2-3-with-support-for-windows-8-1-and-windows-10/)
*   [Microsoft Sysinternals PSTools](https://docs.microsoft.com/en-us/sysinternals/downloads/pstools)
*   [Microsoft Windows 10 Evaluation Center (Microsoft)](https://www.microsoft.com/en-us/evalcenter/evaluate-lab-kit)
*   [Potent Engineer Blog](http://www.potentengineer.com/)
*   [PSAppDeployToolkit](https://psappdeploytoolkit.com/)
*   [Reg2PS](https://reg2ps.azurewebsites.net/)
*   [RuckZuck Tools](https://ruckzuck.tools/)
*   [SQL Server Maintenance Solution (Ola Hallegren)](https://ola.hallengren.com/downloads.html)
*   [WIM Witch – A GUI Driven Solution for Image Customization (Donna Ryan)](https://www.scconfigmgr.com/2019/10/04/wim-witch-a-gui-driven-solution-for-image-customization/)
*   [Windows and Office Deployment Lab Kit (MSDocs)](https://docs.microsoft.com/en-us/microsoft-365/enterprise/modern-desktop-deployment-and-management-lab)
